...
// =============================================================================
// DeviceHandle::Impl — defined here so RtAudio headers stay out of the public API
// =============================================================================

struct DeviceHandle::Impl
{
...
// =============================================================================
// DeviceHandle — member implementations
// =============================================================================

DeviceHandle::DeviceHandle(std::unique_ptr<Impl> impl)
  : p_impl(std::move(impl)) {}

DeviceHandle::~DeviceHandle() = default;

unsigned int DeviceHandle::get_id() const { return p_impl->id; }
const std::string& DeviceHandle::get_name() const { return p_impl->name; }
DeviceHandle::eDeviceType DeviceHandle::get_device_type() const { return p_impl->device_type; }
bool DeviceHandle::is_default_input() const { return p_impl->is_default_input; }
bool DeviceHandle::is_default_output() const { return p_impl->is_default_output; }
unsigned int DeviceHandle::get_output_channels() const { return p_impl->output_channels; }
unsigned int DeviceHandle::get_input_channels() const { return p_impl->input_channels; }
unsigned int DeviceHandle::get_duplex_channels() const { return p_impl->duplex_channels; }
const std::vector<unsigned int>& DeviceHandle::get_sample_rates() const { return p_impl->sample_rates; }
unsigned int DeviceHandle::get_preferred_sample_rate() const { return p_impl->preferred_sample_rate; }

bool DeviceHandle::is_input() const
{
...
bool DeviceHandle::is_output() const
{
  if (p_impl->device_type == eDeviceType::Audio)
...
std::string DeviceHandle::to_string() const
{
  if (p_impl->device_type == eDeviceType::Audio)
  {
    return "DeviceHandle(Type=Audio"
...
bool DeviceHandle::operator==(const DeviceHandle& other) const
{
...
{
  auto impl = std::make_unique<DeviceHandle::Impl>();
  impl->device_type           = DeviceHandle::eDeviceType::Audio;
  impl->id                    = id;
  impl->name                  = name;
  ...
  return DeviceHandlePtr(new DeviceHandle(std::move(impl)));
}
...
{
  auto impl = std::make_unique<DeviceHandle::Impl>();
  impl->device_type       = DeviceHandle::eDeviceType::Midi;
  impl->id                = id;
  impl->name              = name;
