...
public:
   ...
   */
  std::vector<core::IAudioDevicePtr> get_audio_devices() const;
   ...
   */
  core::IAudioDevicePtr get_audio_device(const unsigned int id) const;
   ...
   */
  std::vector<core::IDevicePtr> get_midi_devices() const;
   ...
   *  @throws std::out_of_range if the device with the specified ID does not exist.
   */
  core::IDevicePtr get_midi_device(const unsigned int id) const;
   ...
   */
  core::IDevicePtr get_default_audio_input_device();
   ...
   */
  core::IDevicePtr get_default_audio_output_device();
   ...
   */
  core::IDevicePtr get_default_midi_input_device();
...
private:
  DeviceManager():
    ...
    p_midi_controller(std::make_shared<midi::MidiPortController>())
  {}
...
private:
  audio::AudioStreamControllerPtr p_audio_controller;
  midi::MidiPortControllerPtr p_midi_controller;
};
