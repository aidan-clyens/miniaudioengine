 ...
 *  @brief Internal factory for constructing DeviceHandle objects.
...
{
public:
  /** @brief Create a DeviceHandle for an audio device from explicit fields.
   ...
   *  @return Shared pointer to the constructed DeviceHandle.
   */
  ...
  /** @brief Create a DeviceHandle wrapping a MIDI port.
